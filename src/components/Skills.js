...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      {/* The Device Chassis (Phone on Mobile, Laptop on Desktop) */}
      <motion.div
      ...
      >
        ...
        >
          ...
          {/* --- DESKTOP ONLY: OS Top Menu Bar Strip --- */}
          ...
          {/* Grid of Skill Icons */}
          {/* Added pt-10 on mobile to avoid the notch */}
          ...
          {/* --- MOBILE ONLY: Home Indicator Line --- */}
            ...
            {selectedSkill && (
              ...
              >
                <div className="bg-[#121212] border border-primary w-full max-w-md rounded-xl shadow-[0_0_30px_var(--accent-glow)] flex flex-col max-h-full overflow-hidden">
                  ...
                  {/* Fixed the overflow issue by adding overflow-y-auto here */}
        ...
        {/* --- DESKTOP ONLY: Authentic Laptop Base --- */}
        ...
        {/* Ambient Underglow (Hidden on mobile for cleaner look) */}
